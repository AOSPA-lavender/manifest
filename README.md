...
```bash
repo init -u https://github.com/AOSPA-lavender/manifest -b vauxite
```
...
•  `-r` run a resync before starting lunch 
 ...
 you can check all available flags [here](https://github.com/AOSPA-lavender/android_vendor_aospa/blob/vauxite/build.sh)
